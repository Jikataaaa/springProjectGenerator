package com.example.springprojectgenerator;
...
public class SpringProjectGeneratorApplication {

    public static void main(String[] args) {
        SpringApplication.run(SpringProjectGeneratorApplication.class, args);
    }
    ...
    public CorsFilter corsFilter(){
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList("http://127.0.0.1:5500", "http://127.0.0.1:5500/**"));
